...
class User:
    ...
    def new_customer(new_cust, salary):
        print("Thank you for registering with XYZ!")
...
class Scheme:
    ...
    if city.lower() == "pune":
        ...
        if name=="1":
            print('''Krushna mahila bachat gat\nAddress:Survey No. 18, Sai NagarKondhwa Budruk, Pune - 411048\n Contact no.9876256562''')
            print("For more details visit https://www.sulekha.com/krushna-mahila-bachat-gat-kondhwa-budruk-pune-contact-address")
        elif name=="2":
            print('''Anusuya mahila bachat gat\n Address:495/96 Elina Apartment, Mehun Pura, \nShaniwar Peth, Pune - 411030, Neardakshin Maruti Mandir\n Contact no.9049068863''')
            print("For more details visit https://www.justdial.com/Pune/Anusuya-Mahila-Bachat-Gat-Neardakshin-Maruti-Mandir-Shaniwar-Peth/020PXX20-XX20-160926130309-X8Z6_BZDET")
        elif name=="3":
            print('''Swara mahila bachat gat\n Address:Sr No 26 Munjoba Wasahat Chinchwade Nager Chinchwad, Pune \n Contact no:9766611008.''')
            print("For more details visit https://aadharcenter.com/Swara-Mahila-Bachat-Gat-contact-Prashant-Mohan-Thakare-mobile-9766611008/")
        elif name=="4":
            print('''Gajanan mahila bachat gat\n Address:S. No. 53, 53/1, Kalepadal, Gajanan Colony, Hadapsar, Pune\n Contact no:9922652307''')
        ...
        name = input("Enter the number of the mahila bachat gat: ")
        if name=="1":
            print('''Sneha Mahila Bachat Gat\nAddress:Kolhapur HO, Kolhapur - 416003, Balwant Nagar\n Contact no:9850006125''')
            print("For more Details visit https://www.justdial.com/Kolhapur/Sneha-Mahila-Bachat-Gat-Balwant-Nagar-Kolhapur-HO/0231PX231-X231-130401101609-T2K8_BZDET")
        elif name=="2":
            print('''Jijamata Sway Sahayya Mahila Bachat Gat \n Address:Tervan, Kolhapur - 416509\n Contact no:9595779033''')
            print("For more details https://www.justdial.com/Kolhapur/Jijamata-Sway-Sahayya-Mahila-Bachat-Gat/0231PX231-X231-180224155029-E8F6_BZDET")
        elif name=="3":
            print('''Anjaniprabha Mahila Bachat Gat\n Address:787/2/PL NO 6 Ramanand Nagar Kolhapur\n Contact no:9876345698''')
            print("For more details visit https://www.mastersindia.co/gst-search/?name=anjaniprabha-mahila-bachat-gat-kolhapur&gstin=27AAGAA2707H1Z0")
        elif name=="4":
            print('''Shri Sai Mahila Bachat Gat\n Address:Karnal Sangli Pre Sou Rajshri M Hipparkar 416416 Kolhapur\n Contact no:8796457690''')
        ...
        name = input("Enter the number of the mahila bachat gat: ")
        if name=="1":
            print('''Jyotirling Mahila Bachat Gat\n Address:Malia Nivas Mali Vasti, Jijamata Colony Abhayanagar Sangli\n Contact no:8796458734''')
            print("For more details visit https://www.dnb.com/business-directory/company-profiles.jyotirling_mahila_bachat_gat.89279d4352f4db48a7244a9147c89bba.html")
        elif name=="2":
            print('''Shri Dhanlaxmi Swayamsahayata Mahila Bachat Gat\n Address:AP Tadavale Tal, Sangli\n Contact no:7689564390''')
            print("For more details visit https://local.infobel.in/IN105021226/shri_dhanlaxmi_swayamsahayata_mahila_bachat_gat-sangli.html")
        elif name=="3":
            print('''Anushka Mahila Bachat Gat \n Address:A P Anita Subhash Shinde Kavthepiranmarathi Shala,Sangli\n Contact no:78965090''')
            print("For more details visit https://local.infobel.in/IN111347730/anushka_mahila_bachat_gat-sangli.html")
        elif name=="4":
            print('''Sarsvati Mahila Bachat Gat\n Address:VH2J+XH5, South Shivaji Nagar, Nishant Colony, Sangli Miraj Kupwad\n Contact no: 9879897689 ''')
            print("For more details visit https://local.infobel.in/IN104484184/saraswati_swayam_sahyyata_mahila_bachat_gat-sangli.html")
        else:
            print("Invalid Input!!")
    else:
...
def display():
    ...
    if menu==2:
        ...
        print("7 Logout")
        schm =0
        while schm==1 or schm==2 or schm==3 or schm==4 or schm==5 or schm==6:
